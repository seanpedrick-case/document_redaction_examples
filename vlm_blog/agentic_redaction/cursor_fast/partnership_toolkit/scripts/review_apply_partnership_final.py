...
REVIEW_CSV = Path("output/partnership_toolkit/review_cycle/partnership_review_file_round4.csv").resolve()

OUT_DIR = Path("output_final/partnership_toolkit/final_apply_002").resolve()
