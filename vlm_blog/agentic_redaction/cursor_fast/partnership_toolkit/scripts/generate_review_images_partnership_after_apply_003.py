...
PDF_PATH = Path(
    "output/partnership_toolkit/after_apply_003/7063335af801487c9964185e51ac2065_Partnership-Agreement-Toolkit_0_0_redacted.pdf"
).resolve()
REVIEW_CSV = Path(
...
OUT_DIR = Path("output/partnership_toolkit/review_images_after_apply_003").resolve()
