...
REVIEW_CSV = Path(
    "output/partnership_toolkit/review_cycle/74bedff5a5284893b8e0adb4f024638b_Partnership-Agreement-Toolkit_0_0_review_file_edited.csv"
).resolve()
OUT_DIR = Path("output/partnership_toolkit/after_apply_001").resolve()
