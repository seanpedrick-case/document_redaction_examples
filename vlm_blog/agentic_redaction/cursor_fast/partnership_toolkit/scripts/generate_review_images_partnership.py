...
PDF_PATH = Path(
    "output/partnership_toolkit/initial/74bedff5a5284893b8e0adb4f024638b_Partnership-Agreement-Toolkit_0_0_redacted.pdf"
).resolve()
REVIEW_CSV = Path(
    "output/partnership_toolkit/initial/74bedff5a5284893b8e0adb4f024638b_Partnership-Agreement-Toolkit_0_0_review_file.csv"
).resolve()
OUT_DIR = Path("output/partnership_toolkit/review_images_initial").resolve()
...
def main():
    ...
    (OUT_DIR / "README.txt").write_text(
        f"Rendered {doc.page_count} pages with review CSV boxes.\nPDF: {PDF_PATH}\nCSV: {REVIEW_CSV}\n",
        encoding="utf-8",
    )
