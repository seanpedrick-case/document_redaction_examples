...
PDF_PATH = Path(
    "output/partnership_toolkit/after_apply_002/5b0cb2c713a547609a4cf673d070acb9_Partnership-Agreement-Toolkit_0_0_redacted.pdf"
).resolve()
REVIEW_CSV = Path(
    "output/partnership_toolkit/after_apply_002/5b0cb2c713a547609a4cf673d070acb9_Partnership-Agreement-Toolkit_0_0.pdf_review_file.csv"
).resolve()
OUT_DIR = Path("output/partnership_toolkit/review_images_after_apply_002").resolve()
